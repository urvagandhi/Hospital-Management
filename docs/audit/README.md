...
**Last updated:** 2026-04-21 (6 tech-debt items shipped — see status strip)
...
| **Wanting the "what changed since last audit" delta** | [`00-drift.md`](00-drift.md) §11 "Summary of Drift — Top 10" |
...
**9 audit files** (plus this index) under `docs/audit/`. All files parseable as GitHub-flavored Markdown; Mermaid diagrams in `03-architecture-diagrams.md` render with any CommonMark + Mermaid viewer.
