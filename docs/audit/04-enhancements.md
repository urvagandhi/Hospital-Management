...
| **OBS-004** | Medium | M | **No structured logging in Node backend.** `console.log` statements throughout. Recommendation: `pino` with redaction for secrets + JSON output for Loki/CloudWatch ingestion. |
