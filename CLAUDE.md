...
- **File pipeline:** Android uploads via multipart → Cloudinary public*id `MediVault/h*{hospitalId}/p*{patientMongoId}/{folder_slug}/{date}*{hash}`. Files may be `public`or`signed` (5-min TTL). Thumbnails 120×120 for images.
